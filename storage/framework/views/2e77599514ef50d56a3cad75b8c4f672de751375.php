					...
					<ul class="nav">
						<li class="nav-item nav-profile">
							<a href="#" class="nav-link">
								...
								<div class="nav-profile-text d-flex flex-column">
									<span class="font-weight-bold mb-2">Sport</span>
						...
						<li class="nav-item ">
							...
							<div class="collapse" id="ui-basic1">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item"> <a class="nav-link" href="<?php echo e(route('admin.product')); ?>">Produk</a></li>
						...
						<li class="nav-item ">
							...
							<div class="collapse" id="ui-basic2">
								<ul class="nav flex-column sub-menu">
								<li class="nav-item"> <a class="nav-link" href="<?php echo e(route('admin.pengaturan.alamat')); ?>"> Alamat</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\amanah_sport\resources\views/admin/layout/app.blade.php ENDPATH**/ ?>