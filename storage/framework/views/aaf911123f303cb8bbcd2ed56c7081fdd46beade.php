...
<html lang="en">
  <head>
    <title>Amanah Sport &mdash; Sport Online Shop  </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
              <form action="<?php echo e(route('user.produk.cari')); ?>" method="get" class="site-block-top-search" >
                <?php echo csrf_field(); ?>
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Amanah Sport</a>
              </div>
            </div>
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            <li class="<?php echo e(Request::path() === '/' ? '' : ''); ?>"><a href="<?php echo e(route('home')); ?>">Beranda</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalan Merpati Indah, Pekanbaru</li>
                <li class="phone"><a href="wa.me/082316032626">+62 823 1603 2626</a></li>
                <li class="email">amanahsport@gmail.com</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright Amanah Sport &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved 
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\amanah_sport\resources\views/user/app.blade.php ENDPATH**/ ?>