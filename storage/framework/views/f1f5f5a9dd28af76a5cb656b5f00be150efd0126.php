        ...
        <?php echo csrf_field(); ?>
            ...
            <tbody>
                ...
                <td class="product-thumbnail">
                    <img src="<?php echo e(asset('storage/'.$keranjang->image)); ?>" alt="Image" class="img-fluid" width="150">
                </td>
                ...
                <td>
                    ...
                    <input type="text" name="qty[]" class="form-control text-center" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" value="<?php echo e($keranjang->qty); ?>">
...
<?php echo $__env->make('user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amanah_sport\resources\views/user/keranjang.blade.php ENDPATH**/ ?>